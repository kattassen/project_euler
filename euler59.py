...
print (len(cipher)-1)%3
x = []
y = []
z = []

#freq_x = "aeorisntlmdcphbukgyfwjvzxqASERBTMLNPOIDCHGKFJUW.!Y*@V-ZQX_"
#freq_y = "aeorisntlmdcphbukgyfwjvzxqASERBTMLNPOIDCHGKFJUW.!Y*@V-ZQX_"
#freq_z = "aeorisntlmdcphbukgyfwjvzxqASERBTMLNPOIDCHGKFJUW.!Y*@V-ZQX_"
